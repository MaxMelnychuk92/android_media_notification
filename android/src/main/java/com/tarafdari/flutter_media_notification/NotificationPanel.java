...
//        MediaButtonReceiver.handleIntent(mediaSession, prevIntent);
        ...
        //Retro
        Intent retroIntent = new Intent(this, NotificationReturnSlot.class)
                .setAction("retro");
        PendingIntent pendingRetroIntent = PendingIntent.getBroadcast(this, 0, retroIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        ///view.setOnClickPendingIntent(R.id.retro, pendingRetroIntent);

        //forward
        Intent forwardIntent = new Intent(this, NotificationReturnSlot.class)
                .setAction("forward");
        PendingIntent pendingForwardIntent = PendingIntent.getBroadcast(this, 0, forwardIntent, PendingIntent.FLAG_UPDATE_CURRENT);
...
//        MediaButtonReceiver.handleIntent(mediaSession, selectIntent);
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .addAction(R.drawable.ic_rewind_10_black_48dp , "retro", pendingRetroIntent)
                .addAction(iconPlayPause, titlePlayPause, pendingToggleIntent)
                .addAction(R.drawable.ic_fast_forward_30_black_48dp, "forward",  pendingForwardIntent)
